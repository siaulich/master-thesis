...
\begin{figure}[H]
    ...
    \label{fig:feature_2d_mttbar_njets}
\end{figure}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{plots/compact_reconstructor_nu_weighter/binned_performance/N_jets/binned_dev_px_N_jets.pdf}
    \caption{
        Mean absolute error of the neutrinos' $p_x$ component binned in number jets.
    }
    \label{fig:px_dev_njets}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{plots/compact_reconstructor_nu_weighter/binned_performance/N_jets/binned_dev_pz_N_jets.pdf}
    \caption{
        Mean absolute error of the neutrinos' $p_z$ component binned in number jets.
    }
    \label{fig:pz_dev_njets}
\end{figure}
