...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Simulation of the distributions of  $c_{\text{hel}}$ and $c_{\text{han}}$ for dileptonic decaying top-quark pairs produced near threshold for different spin states and combinations thereof. The distributions are normalised to unity and at parton level. The Figures are taken from Reference~\cite{atlas_toponium}.}
\end{figure}