...
While a complete analysis requires detailed investigation of background processes contributing to the signal regions, the following chapters focuses on developing and evaluating machine-learning methods applied to \ttbar events.
Therefore, only the signal process of \ttbar production with dileptonic decays is described here. The background processes and their simulation is discussed in the later \Cref{chap:physics-analysis}, that provides a data-driven validation of the method.
