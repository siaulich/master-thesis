...
\begin{tikzpicture}[
      ...
      % Regression DNN
      \node[dnn_block, right=2.5cm of lepton_1_output, minimum height = 0.8cm] (lepton_1_reg) {Reg. DNN};
      \node[dnn_block, right=2.5cm of lepton_2_output,minimum height = 0.8cm] (lepton_2_reg) {Reg. DNN};
      ...
      \draw[arrow] (met_dnn.east -| transformer_n.east) -| ($(lepton_1_reg.west)+(-0.6,0)$) --  (lepton_1_reg.west);
      
      \node[fill=white, inner sep = 0.1cm, outer sep = 0] at ($(lepton_1_reg.west)+(-0.6,0)$) (conact_jet_1) {$\bigoplus$};
      \node[fill=white, inner sep = 0.1cm, outer sep = 0] at ($(lepton_2_reg.west)+(-0.6,0)$) (conact_jet_1) {$\bigoplus$};
