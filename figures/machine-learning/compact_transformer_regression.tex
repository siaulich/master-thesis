...
\begin{tikzpicture}[
      ...
      % Regression DNN
      \node[dnn_block, right=3cm of lepton_1_output, minimum height = 0.8cm] (lepton_1_reg) {Reg. DNN};
      \node[dnn_block, right=3cm of lepton_2_output,minimum height = 0.8cm] (lepton_2_reg) {Reg. DNN};
      ...
      \coordinate (concat_lepton_1) at ($(lepton_1_reg.west)+(-0.65,0)$);
      \coordinate (concat_lepton_2) at ($(lepton_2_reg.west)+(-0.65,0)$);
      ...
      \draw[arrow] (met_dnn.east -| transformer_n.east) -|  (concat_lepton_2) --  (lepton_2_reg.west);

      \draw[arrow] (met_dnn.east -| transformer_n.east) -| (concat_lepton_1)  --  (lepton_1_reg.west);



      % Arrows from cross-attention to regression DNNs

      \draw[arrow] (cross_attention.east |- jet_1_output) -| (concat_lepton_1) -- (lepton_1_reg.west);
      \draw[arrow] (cross_attention.east |- jet_n_output) -| (concat_lepton_1) -- (lepton_1_reg.west);
      \draw[arrow] (cross_attention.east |- jet_1_output) -| (concat_lepton_2) -- (lepton_2_reg.west);
      \draw[arrow] (cross_attention.east |- jet_n_output) -| (concat_lepton_2) -- (lepton_2_reg.west);


      \node[fill=white, inner sep = 0.1cm, outer sep = 0] at (concat_lepton_1) {$\bigoplus$};
      \node[fill=white, inner sep = 0.1cm, outer sep = 0] at (concat_lepton_2) {$\bigoplus$};
