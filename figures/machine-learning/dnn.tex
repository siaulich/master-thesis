...
\tikzset{
  ...
  node in/.style={node,fill=green!20},
  node hidden/.style={node,fill=blue!20},
  node out/.style={node,fill=red!20},
...
\begin{tikzpicture}[x=2.2cm,y=1.4cm]
  ...
  \node[above=2,align=center,blue!60!black] at (N3-1.90) {hidden layers};
