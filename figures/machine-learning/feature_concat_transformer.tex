...
\node[fill=white, inner sep = 0.1cm, outer sep = 0] at ($(jet_1)+(1.5,0)$) (conact_jet_1) {$\bigoplus$};
\node[fill=white, inner sep = 0.1cm, outer sep = 0] at ($(jet_n)+(1.5,0)$) (conact_jet_n) {$\bigoplus$};
