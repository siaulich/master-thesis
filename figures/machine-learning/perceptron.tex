...
\tikzset{activation/.style={basic,circle,fill=cyan!20}}
\tikzset{input/.style={basic,circle,fill=green!20}}
\tikzset{weights/.style={basic,rectangle}}
\tikzset{sum/.style={basic,circle,fill=orange!20}}
\tikzset{functions/.style={basic,circle,fill=blue!30}}
\tikzset{output/.style={basic,circle,fill=red!20}}
...
\begin{document}
    \begin{tikzpicture}
        ...
        \node[output, right = of center] (right) {$\hat a$};
        ...
        \node[below of=right, font=\scriptsize] {output};
    \end{tikzpicture}
\end{document}